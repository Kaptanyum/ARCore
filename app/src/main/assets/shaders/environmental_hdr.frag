...
// ArActivity.updateSphericalHarmonicsCoefficients for more information.
...
vec3 Pbr_CalculateDiffuseEnvironmentalRadiance(const vec3 normal,
  ...
  // See ArActivity.updateSphericalHarmonicsCoefficients() for more
...
vec3 Pbr_CalculateEnvironmentalRadiance(
  ...
  // ArActivity.sphericalHarmonicsFactors.
  vec3 diffuseTerm =
